...
data:
  ...
  bundledCode: "#line 1 \"verify/unit_test/geometry/geometry_regression.test.cpp\"\
    ...
    \ nex), l)[0]);\n        }\n    }\n    return res;\n}\n#line 8 \"verify/unit_test/geometry/geometry_regression.test.cpp\"\
    \nint main() {\n    assert(convex_hull(vector<Point>{}).empty());\n    assert(eq(convex_diameter(vector<Point>{}),\
    ...
    \    assert(tangent_cp(Circle(Point(0, 0), 2), Point(1, 0)).empty());\n    assert(tangent_cp(Circle(Point(0,\
    \ 0), 2), Point(2, 0)).size() == 1);\n    int a, b;\n    cin >> a >> b;\n    cout\
    \ << a + b << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/aplusb\"\n#include \"../../../src/template/template.hpp\"\
    ...
    \    assert(eq(convex_diameter(vector<Point>{}), 0.0));\n    assert(eq(convex_diameter(vector<Point>{Point(1,\
    \ 2)}), 0.0));\n    assert(intersection_cc(Circle(Point(0, 0), 1), Circle(Point(0,\
    \ 0), 1)).empty());\n    assert(intersection_cc(Circle(Point(0, 0), 1), Circle(Point(3,\
    \ 0), 1)).empty());\n    assert(tangent_cp(Circle(Point(0, 0), 2), Point(1, 0)).empty());\n\
  ...
  verifiedWith: []
documentation_of: verify/unit_test/geometry/geometry_regression.test.cpp
layout: document
redirect_from:
- /verify/verify/unit_test/geometry/geometry_regression.test.cpp
- /verify/verify/unit_test/geometry/geometry_regression.test.cpp.html
