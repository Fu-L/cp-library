...
data:
  ...
  bundledCode: "#line 1 \"verify/unit_test/fps/formal_power_series_regression.test.cpp\"\
    ...
    \ 5 \"src/convolution/convolution_ll.hpp\"\nvector<long long> convolution_ll(const\
    ...
    \ == -1) deg = n;\n        if(deg > n) (*this).resize(deg + 1);\n        for(int\
    \ i = 0; i < deg - d; ++i) {\n            (*this)[i + d] -= (*this)[i] * c;\n\
    \        }\n    }\n};\n#line 7 \"verify/unit_test/fps/formal_power_series_regression.test.cpp\"\
    \nusing mint = StaticModint<998244353>;\nusing mint2 = StaticModint<1000000007>;\n\
    template <typename FPS>\nvoid test_common() {\n    FPS f{1, 2, 3};\n    f = vector<typename\
    \ FPS::value_type>{4};\n    assert(f.size() == 1);\n    assert(f[0] == typename\
    \ FPS::value_type(4));\n    FPS g{1, 2, 3};\n    FPS h = -g;\n    assert(g[0]\
    \ == typename FPS::value_type(1));\n    assert(g[1] == typename FPS::value_type(2));\n\
  ...
  verifiedWith: []
documentation_of: verify/unit_test/fps/formal_power_series_regression.test.cpp
layout: document
redirect_from:
- /verify/verify/unit_test/fps/formal_power_series_regression.test.cpp
- /verify/verify/unit_test/fps/formal_power_series_regression.test.cpp.html
