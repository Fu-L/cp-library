...
data:
  ...
  bundledCode: "#line 1 \"verify/unit_test/string/suffix_array.test.cpp\"\n#define\
    ...
    \ compress = true) {\n    if(s.empty()) return {};\n    auto sa_is = [&](auto&\
    \ sa_is, const vector<int>& s, const int upper) -> vector<int> {\n        const\
    \ int n = (int)s.size();\n        if(n == 0) return {};\n        if(n == 1) return\
    ...
    \ s2(n);\n    for(int i = 0; i < n; ++i) {\n        s2[i] = s[i];\n    }\n   \
    \ return lcp_array(s2, sa);\n}\n#line 4 \"verify/unit_test/string/suffix_array.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/unit_test/string/suffix_array.test.cpp
layout: document
redirect_from:
- /verify/verify/unit_test/string/suffix_array.test.cpp
- /verify/verify/unit_test/string/suffix_array.test.cpp.html
