...
data:
  ...
  bundledCode: "#line 1 \"verify/unit_test/graph/graph_regression.test.cpp\"\n#define\
    ...
    \ <typename T>\nstruct Matrix {\n    Matrix(const int h, const int w, const T&\
    ...
    \        for(int j = 0; j < n - 1; ++j) {\n            lap[i][j] = mat[i][j];\n\
    \        }\n    }\n    return gauss_elimination(lap).second;\n}\n#line 7 \"verify/unit_test/graph/graph_regression.test.cpp\"\
    \nusing mint = modint998244353;\nint main() {\n    Graph<int> empty(0);\n    {\n\
    \        auto [cost, edges] = kruskal<int>(0, {});\n        assert(cost == 0);\n\
    \        assert(edges.empty());\n    }\n    assert(counting_spanning_tree_undirected<mint>(empty)\
    \ == mint(1));\n    Graph<int> one(1);\n    assert(counting_spanning_tree_undirected<mint>(one)\
    \ == mint(1));\n    int a, b;\n    cin >> a >> b;\n    cout << a + b << '\\n';\n\
    }\n"
  ...
  verifiedWith: []
documentation_of: verify/unit_test/graph/graph_regression.test.cpp
layout: document
redirect_from:
- /verify/verify/unit_test/graph/graph_regression.test.cpp
- /verify/verify/unit_test/graph/graph_regression.test.cpp.html
