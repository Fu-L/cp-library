...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker/matrix/counting_spanning_tree_directed.test.cpp\"\
    ...
    #line 4 \"verify/library_checker/matrix/counting_spanning_tree_directed.test.cpp\"\
    ...
    \      if(j == r) {\n                w = 1;\n                continue;\n     \
    \       }\n            lap[i - h][j - w] = mat[i][j];\n        }\n        w =\
    \ 0;\n    }\n    return gauss_elimination(lap).second;\n}\n#line 7 \"verify/library_checker/matrix/counting_spanning_tree_directed.test.cpp\"\
    \nint main(void) {\n    int n, m, r;\n    cin >> n >> m >> r;\n    Graph<int>\
    \ g(n);\n    rep(i, 0, m) {\n        int u, v;\n        cin >> u >> v;\n     \
