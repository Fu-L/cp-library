...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker/linear_algebra/inverse_matrix.test.cpp\"\
    ...
    \    const int n = a.H();\n    Matrix<T> m(n, 2 * n);\n    for(int i = 0; i <\
    \ n; ++i) {\n        for(int j = 0; j < n; ++j) {\n            m[i][j] = a[i][j];\n\
    \        }\n        m[i][n + i] = 1;\n    }\n    if(gauss_elimination(m, n).first\
    \ != n) {\n        Matrix<T> res(0, 0);\n        return res;\n    }\n    Matrix<T>\
    \ b(n, n);\n    for(int i = 0; i < n; ++i) {\n        for(int j = 0; j < n; ++j)\
    \ {\n            b[i][j] = m[i][j + n];\n        }\n    }\n    return b;\n}\n\
    #line 6 \"verify/library_checker/linear_algebra/inverse_matrix.test.cpp\"\nusing\
  ...
  verifiedWith: []
documentation_of: verify/library_checker/linear_algebra/inverse_matrix.test.cpp
layout: document
redirect_from:
- /verify/verify/library_checker/linear_algebra/inverse_matrix.test.cpp
- /verify/verify/library_checker/linear_algebra/inverse_matrix.test.cpp.html
