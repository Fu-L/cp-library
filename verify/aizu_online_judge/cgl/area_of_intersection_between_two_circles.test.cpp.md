...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/area_of_intersection_between_two_circles.test.cpp\"\
    ...
    \ 0.0;\n    Real S = 0;\n    for(int i = 0; i < n; ++i) {\n        S += cross_area(c,\
    \ ps[i], ps[(i + 1) % n]);\n    }\n    return S;\n}\n#line 6 \"verify/aizu_online_judge/cgl/area_of_intersection_between_two_circles.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/area_of_intersection_between_two_circles.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/area_of_intersection_between_two_circles.test.cpp
- /verify/verify/aizu_online_judge/cgl/area_of_intersection_between_two_circles.test.cpp.html
