...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/intersection_of_a_circle_and_a_polygon.test.cpp\"\
    ...
    \ 0.0;\n    Real S = 0;\n    for(int i = 0; i < n; ++i) {\n        S += cross_area(c,\
    \ ps[i], ps[(i + 1) % n]);\n    }\n    return S;\n}\n#line 7 \"verify/aizu_online_judge/cgl/intersection_of_a_circle_and_a_polygon.test.cpp\"\
    \nint main(void) {\n    int n, r;\n    cin >> n >> r;\n    Circle c = Circle(Point(0.0,\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/intersection_of_a_circle_and_a_polygon.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/intersection_of_a_circle_and_a_polygon.test.cpp
- /verify/verify/aizu_online_judge/cgl/intersection_of_a_circle_and_a_polygon.test.cpp.html
