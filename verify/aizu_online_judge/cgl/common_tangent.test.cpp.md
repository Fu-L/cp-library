...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/common_tangent.test.cpp\"\n\
    ...
    \ 8 \"verify/aizu_online_judge/cgl/common_tangent.test.cpp\"\nint main(void) {\n\
    \    Circle c1, c2;\n    cin >> c1.p >> c1.r >> c2.p >> c2.r;\n    vector<Line>\
    \ res = tangent_cc(c1, c2);\n    vector<Point> ans;\n    for(const Line& l : res)\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/common_tangent.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/common_tangent.test.cpp
- /verify/verify/aizu_online_judge/cgl/common_tangent.test.cpp.html
