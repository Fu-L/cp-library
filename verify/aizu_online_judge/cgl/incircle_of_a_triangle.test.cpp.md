...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/incircle_of_a_triangle.test.cpp\"\
    ...
    \ 0.0;\n    Real S = 0;\n    for(int i = 0; i < n; ++i) {\n        S += cross_area(c,\
    \ ps[i], ps[(i + 1) % n]);\n    }\n    return S;\n}\n#line 7 \"verify/aizu_online_judge/cgl/incircle_of_a_triangle.test.cpp\"\
    \nint main(void) {\n    Point p1, p2, p3;\n    cin >> p1 >> p2 >> p3;\n    Circle\
    \ c = inscribed_circle(p1, p2, p3);\n    cout << c.p << ' ' << c.r << '\\n';\n\
    }\n"
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/incircle_of_a_triangle.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/incircle_of_a_triangle.test.cpp
- /verify/verify/aizu_online_judge/cgl/incircle_of_a_triangle.test.cpp.html
