...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/cross_point.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_C\"\
    ...
    \ s, const Line& l) {\n    return dist_ls(l, s);\n}\n#line 7 \"verify/aizu_online_judge/cgl/cross_point.test.cpp\"\
    \nint main(void) {\n    int q;\n    cin >> q;\n    while(q--) {\n        Point\
    \ p0, p1, p2, p3;\n        cin >> p0 >> p1 >> p2 >> p3;\n        Segment s1 =\
    \ Segment(p0, p1), s2 = Segment(p2, p3);\n        auto cross_point = intersection_ss(s1,\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/cross_point.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/cross_point.test.cpp
- /verify/verify/aizu_online_judge/cgl/cross_point.test.cpp.html
