...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/projection.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_1_A\"\
    ...
    \ s, const Line& l) {\n    return dist_ls(l, s);\n}\n#line 7 \"verify/aizu_online_judge/cgl/projection.test.cpp\"\
    \nint main(void) {\n    Point p1, p2;\n    cin >> p1 >> p2;\n    Line l = Line(p1,\
    \ p2);\n    int q;\n    cin >> q;\n    while(q--) {\n        Point p;\n      \
    \  cin >> p;\n        cout << projection(l, p) << '\\n';\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/projection.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/projection.test.cpp
- /verify/verify/aizu_online_judge/cgl/projection.test.cpp.html
